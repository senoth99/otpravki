      ...
      <div className="flex max-h-[94dvh] w-full max-w-lg flex-col overflow-hidden rounded-t-3xl bg-white shadow-2xl sm:rounded-3xl">
        <div className="border-b border-amber-100 bg-amber-50 px-5 py-4">
          ...
          <h2 className="mt-1 text-xl font-bold tracking-tight text-gray-900">
            {emoji ? `${emoji} ` : ""}Качество — твоя зона
          </h2>
          <p className="mt-1 text-sm text-amber-950/80">
            Прочитай перед работой. Клиент получает то, что ты собрал и отправил.
          </p>
        </div>

        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto overscroll-contain px-5 py-4 text-sm leading-relaxed text-gray-700">
          <p>
            Каждое изделие должно выглядеть <strong className="text-gray-900">эталонно</strong> —
            как на сайте. Не пропускай брак: пятна, кривой принт, зацепки, порезы, отошедшую плёнку.
          </p>

          <ul className="space-y-2.5">
            <li className="rounded-2xl border border-gray-100 bg-gray-50 px-3.5 py-3">
              <p className="text-[11px] font-semibold uppercase tracking-wide text-gray-400">
                Сборка
              </p>
              <p className="mt-1">
                Сверяй позиции, размер и количество. Смотри вещь при хорошем свете перед
                упаковкой.
              </p>
            </li>
            <li className="rounded-2xl border border-gray-100 bg-gray-50 px-3.5 py-3">
              ...
              <p className="mt-1">
                Правильный заказ, правильный комплект, аккуратная упаковка. Ошибка на этом
                этапе — сразу клиенту.
              </p>
            </li>
            <li className="rounded-2xl border border-gray-100 bg-gray-50 px-3.5 py-3">
              ...
              <p className="mt-1">
                Нашёл дефект — изолируй, пометь, сообщи. Не отправляй «на всякий случай».
                Сомневаешься — стоп, уточни у руководителя.
              </p>
            </li>
          </ul>

          <p className="text-xs text-gray-500">
            Полный регламент и примеры брака — в разделе «Инструкция».
          </p>
        </div>

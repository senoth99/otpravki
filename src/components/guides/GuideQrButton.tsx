          ...
          >
            ...
            <div className="mt-4 flex gap-2">
              ...
              <button
                ...
                className="inline-flex min-h-11 flex-1 cursor-pointer items-center justify-center rounded-xl bg-gray-900 text-sm font-medium text-white active:bg-gray-800 disabled:opacity-50"
              >
                Скачать
              </button>
            </div>

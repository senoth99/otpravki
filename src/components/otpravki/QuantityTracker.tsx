    ...
    <div className="flex w-full flex-col gap-2 sm:w-36">
      ...
      <div className="flex w-full items-center gap-2">
        <button
          ...
          className="flex h-11 min-h-[44px] w-11 shrink-0 items-center justify-center rounded-xl border border-gray-200 text-sm font-medium text-gray-600 transition-colors active:bg-gray-50 disabled:pointer-events-none disabled:border-transparent disabled:opacity-0"
